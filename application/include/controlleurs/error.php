 ...
 * 
 * C'est dans cette partie que l'on créé les fonctions php qui seront appelées par la vue
 ...
 *  localisés dans les "connecteurs" de la base de données, ceux-ci étants 
